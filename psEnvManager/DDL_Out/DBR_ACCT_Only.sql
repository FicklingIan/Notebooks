...
-- +------------------------------------------------------------------------------------------------------+
   ...
   CREATE ROLE IF NOT EXISTS PROD3_EDW_ETL_DEV;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT ROLE PROD3_EDW_ETL_DEV TO ROLE PROD3_EDW_SYSADMIN;
   GRANT ROLE PROD3_EDW_ANALYST TO ROLE PROD3_EDW_SYSADMIN;
   GRANT ROLE PROD3_EDW_DATA_SCI TO ROLE PROD3_EDW_SYSADMIN;

-- +------------------------------------------------------------------------------------------------------+
-- | Grant database functional roles to PROD3_EDW_SYSADMIN                                                |
-- +------------------------------------------------------------------------------------------------------+

USE ROLE PROD3_EDW_SYSADMIN;
USE DATABASE PROD3_EDW;
   GRANT DATABASE ROLE ETL_DEV TO ROLE PROD3_EDW_SYSADMIN;
   GRANT DATABASE ROLE ANALYST TO ROLE PROD3_EDW_SYSADMIN;
   GRANT DATABASE ROLE DATA_SCI TO ROLE PROD3_EDW_SYSADMIN;

-- +------------------------------------------------------------------------------------------------------+
-- | Grant database functional roles to account level functional roles                                    |
-- +------------------------------------------------------------------------------------------------------+

   GRANT DATABASE ROLE ETL_DEV TO ROLE PROD3_EDW_ETL_DEV;
   GRANT DATABASE ROLE ANALYST TO ROLE PROD3_EDW_ANALYST;
   GRANT DATABASE ROLE DATA_SCI TO ROLE PROD3_EDW_DATA_SCI;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT DATABASE ROLE _RAW_SU TO ROLE PROD3_EDW_SYSADMIN;
   ...
   GRANT DATABASE ROLE _EDW_SU TO ROLE PROD3_EDW_SYSADMIN;
   ...
   GRANT DATABASE ROLE _MART_SU TO ROLE PROD3_EDW_SYSADMIN;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT ROLE _PROD3_EDW_ADHOC_WH_WU TO ROLE PROD3_EDW_ETL_DEV;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT USAGE ON DATABASE PROD3_EDW TO DATABASE ROLE _RAW_SU;
   ...
   GRANT USAGE ON DATABASE PROD3_EDW TO DATABASE ROLE _EDW_SU;
   ...
   GRANT USAGE ON DATABASE PROD3_EDW TO DATABASE ROLE _MART_SU;
