...
-- +------------------------------------------------------------------------------------------------------+
   ...
   CREATE ROLE IF NOT EXISTS PROD2_EDW_ETL_DEV;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT ROLE PROD2_EDW_ETL_DEV TO ROLE PROD2_EDW_SYSADMIN;
...
USE ROLE PROD2_EDW_SYSADMIN;
USE DATABASE PROD2_EDW;
   GRANT DATABASE ROLE ETL_DEV TO ROLE PROD2_EDW_SYSADMIN;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT DATABASE ROLE ETL_DEV TO ROLE PROD2_EDW_ETL_DEV;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT DATABASE ROLE _RAW_SU TO ROLE PROD2_EDW_SYSADMIN;
   ...
   GRANT DATABASE ROLE _EDW_SU TO ROLE PROD2_EDW_SYSADMIN;
   ...
   GRANT DATABASE ROLE _MART_SU TO ROLE PROD2_EDW_SYSADMIN;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT DATABASE ROLE _RAW_SFULL TO ROLE PROD2_EDW_ETL_DEV;
   GRANT DATABASE ROLE _RAW_RO TO DATABASE ROLE ANALYST;
   GRANT DATABASE ROLE _RAW_RO TO ROLE PROD2_EDW_ANALYST;
   GRANT DATABASE ROLE _RAW_RW TO DATABASE ROLE DATA_SCI;
   GRANT DATABASE ROLE _RAW_RW TO ROLE PROD2_EDW_DATA_SCI;
   GRANT DATABASE ROLE _EDW_SFULL TO DATABASE ROLE ETL_DEV;
   GRANT DATABASE ROLE _EDW_SFULL TO ROLE PROD2_EDW_ETL_DEV;
   GRANT DATABASE ROLE _EDW_RO TO DATABASE ROLE ANALYST;
   GRANT DATABASE ROLE _EDW_RO TO ROLE PROD2_EDW_ANALYST;
   GRANT DATABASE ROLE _EDW_RO TO DATABASE ROLE DATA_SCI;
   GRANT DATABASE ROLE _EDW_RO TO ROLE PROD2_EDW_DATA_SCI;
   GRANT DATABASE ROLE _MART_SFULL TO DATABASE ROLE ETL_DEV;
   GRANT DATABASE ROLE _MART_SFULL TO ROLE PROD2_EDW_ETL_DEV;
   GRANT DATABASE ROLE _MART_RO TO DATABASE ROLE ANALYST;
   GRANT DATABASE ROLE _MART_RO TO ROLE PROD2_EDW_ANALYST;
   GRANT DATABASE ROLE _MART_RO TO DATABASE ROLE DATA_SCI;
   GRANT DATABASE ROLE _MART_RO TO ROLE PROD2_EDW_DATA_SCI;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT ROLE _PROD2_EDW_ADHOC_WH_WU TO ROLE PROD2_EDW_ETL_DEV;
...
-- +------------------------------------------------------------------------------------------------------+
   ...
   GRANT USAGE ON DATABASE PROD2_EDW TO DATABASE ROLE _RAW_SU;
   ...
   GRANT USAGE ON DATABASE PROD2_EDW TO DATABASE ROLE _EDW_SU;
   ...
   GRANT USAGE ON DATABASE PROD2_EDW TO DATABASE ROLE _MART_SU;
